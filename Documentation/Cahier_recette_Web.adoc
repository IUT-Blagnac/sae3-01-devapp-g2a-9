...
| - Les produits retournés correspondent à la catégorie selectionnée
| 

| TestRechercheSousCategorie
| Rechercher par sous catégorie
| Les produits retournés correspondent à la sous catégorie de selecionnée
| - Une catégorie doit etre selectionnée

| TestRecherchePrixMin
| Recherche par prix minimum
| Les produits retournés ont un prix superieur a la valeure choisie
|

| TestRecherchePrixMax
| Recherche par prix maximum
| Les produits retournés ont un prix inferieur a la valeure choisie
|
...
| - Le prix minimum doit etre inferieur au prix maximum
