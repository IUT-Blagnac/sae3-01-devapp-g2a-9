            ...
            <main class="apropos">
                <div class="main-card">
                    ...
                    <p>
                        ...
                        Téléphone : <span alt="COPIER" style="color: lightblue; cursor: pointer; text-decoration: underline;" onclick="navigator.clipboard.writeText('+33 4 56 39 82 90');">+33 4 56 39 82 90</span>
