...
Suite à la crise sanitaire son chiffre d'affaire a drastiquement baissé et est actuellement stagnante.
...
Leur site s'adresse néamoins uniquement aux usagers présent sur le territoire Français pour des raisons de facilité.

=== Affectation des rôles 

Thomas Demeyere : SCRUM Master
Oryann Prochaska : MOA
...
Nous utiliseront pour cela les fonctionnalités de GitHub pour les https://docs.github.com/en/repositories/releasing-projects-on-github[Releases].
